...
function ModalResepView({closeModalView}) {
    return (
        <>
            <div
                            ...
                            <div className="container mx-auto max-w-full">
                                ...
                                <div className="grid grid-cols-5 h-20">
                                    ...
                                    <div className="col-start-3 col-end-5 px-4 mb-2">
                                        ...
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Pura Kitchen" readonly/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-5 h-20">
                                    <div className="col-start-1 col-end-3 px-4 mb-2">
                                        <label className="text-secondary500 text-sm">Nama</label><br/>
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Nasi Ayam Panggang" readonly/>    
                                    </div>
                                    <div className="col-start-3 col-end-5 px-4 mb-2">
                                        <label className="text-secondary500 text-sm">Porsi</label><br/>
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="2 Orang" readonly/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-5 h-20">
                                    <div className="col-start-1 col-end-3 px-4 mb-2">
                                    ...
                                    <div className="col-start-3 col-end-5 px-4 mb-2">
                                        ...
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Mudah" readonly/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-5 h-20">
                                    <div className="col-start-1 col-end-3 px-4 mb-2">
                                        <label className="text-secondary500 text-sm">Kalori</label><br/>
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="82 Kalori" readonly/>    
                                    </div>
                                    <div className="col-start-3 col-end-6 px-4 mb-2">
                                        <label className="text-secondary500 text-sm">Kategori</label><br/>
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Makanan Utama, Nasi, Ayam" readonly/>
                                    </div>
                                </div>
                                <div className="grid grid-cols-5">
                                    <div className="col-start-1 col-end-6 px-4 mb-2">
                                        <label className="text-secondary500 text-sm">Komposisi</label><br/>
                                        <textarea className="w-full px-3 py-2 mt-1 text-gray-700 border border-greyLight rounded-lg focus:outline-none" rows="2" readonly>                                           
                                            5 potong paha ayam,
                                ...
                                <div className="grid grid-cols-5">
                                    <div className="col-start-1 col-end-6 px-4 mb-2">
                                        ...
                                        <textarea className="w-full px-3 py-2 mt-1 text-gray-700 border border-greyLight rounded-lg focus:outline-none" rows="3" readonly>
