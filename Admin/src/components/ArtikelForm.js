...
import ModalDelete from './ModalArtikelDelete';
        ...
        <Card>
            <CardHeader color="green" contentPosition="none">
                <div className="w-full flex items-center justify-between">
                    <h2 className="text-white text-2xl">Artikel</h2>
                </div>
            </CardHeader>
                            ...
                            <tr key={article.id}>
                                ...
                                <td className="border-b border-gray-200 align-middle font-light text-sm whitespace-nowrap px-2 py-3 text-left">
                                    <div className="flex flex-col space-y-1 lg:space-x-4 lg:flex-row lg:items-end">
                                        <Link className="" to={`/lihat-artikel/${article.id}`}><img src={View} alt="Tombol Lihat"/></Link>
                                        <Link className="" to={`/edit-artikel/${article.id}`}><img src={Edit} alt="Tombol Edit"/></Link>
                                        <button className="" 
                                            onClick={() => {
                                                setShowModalDelete(true);
                                                setDeleteItem(article.id);
                                                setNameItem(article.title);
                                            }}>
