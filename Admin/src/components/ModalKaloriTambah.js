...
function ModalKaloriTambah({closeModalTambah}) {
    return (
        <>
            <div
                            ...
                            <div className="container mx-auto max-w-full">
                                <div className="grid grid-cols-5 h-20">
                                    <div className="col-start-1 col-end-4 px-4 mb-2">
                                        ...
                                        <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Telur" />    
                                    </div>
                                ...
                                <div className="grid grid-cols-5 xl:h-20">
                                        <div className="col-start-1 col-end-4 px-4 mb-8">
                                            ...
                                            <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="Ceplok" />    
                                        </div>
                                        <div className="col-start-4 col-end-5 px-4 mb-8">
                                            <label className="text-secondary500 text-sm">Kalori</label><br/>
                                            <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="128 kal" />    
                                        </div>
                                        <div className="col-start-5 col-end-6 px-4 mb-8">
                                            <label className="text-secondary500 text-sm">Karbo</label><br/>
                                            <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="28.5 g" />    
                                        </div>
                                </div>
                                <div className="grid grid-cols-5 h-20">
                                        <div className="col-start-1 col-end-4 px-4 mb-8">
                                            <label className="text-secondary500 text-sm">Jumlah Bahan</label><br/>
                                            <input type="text" className="p-4 w-full h-10 rounded pl-4 mt-1 text-sm border border-greyLight" value="1 Butir" />    
                                        </div>
                                        <div className="col-start-4 col-end-5 px-4 mb-8">
                                ...
                                <div className="grid grid-cols-5">
                                    <div className="col-start-1 col-end-6 px-4 mb-2">
                                        ...
                                        <textarea className="w-full px-3 py-2 text-gray-700 border border-greyLight rounded-lg focus:outline-none" rows="4" >
                                            Telur adalah salah satu bahan makanan hewani yang dikonsumsi selain daging, ikan, dan susu.
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            <div className="flex justify-end mr-4 space-x-4">
                                <Button
                                    color="blueGray"
                                    buttonType="filled"
                                    size="regular"
...
export default ModalKaloriTambah;
