    ...
    <div classNameName="App">
      ...
      <div className="rating-section">
        ...
        By downloading or using the app, these terms will
                  automatically apply to you should make sure therefore
                  ...
                  to it, still belong to PENS.
        </p> 
        <p>
                  PENS is committed to ensuring that the app is
        ...
        <p>
                  The Calorilin app stores and processes personal data that
                  ...
                  that the Calorilin app won't work properly or at all.
        </p> 
        <p>
        ...
        <p>
                  ...
                  PENS will not take responsibility for. Certain
                  functions of the app will require the app to have an active
                  internet connection. The connection can be Wi-Fi or provided
                  by your mobile network provider, but PENS
        ...
        <p>
                  Along the same lines, PENS cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged if it runs out of
                  battery and you can't turn it on to avail the Service,
                  PENS cannot accept responsibility.       
        </p> <p>
                  With respect to PENS's responsibility for your
                  use of the app, when you're using the app, it's important to
                  bear in mind that although we endeavor to ensure that it is
                  updated and correct at all times, we do rely on third parties
                  to provide information to us so that we can make it available
                  to you. PENS accepts no liability for any
                  ...
                  using the app. PENS does not promise that it
                  ...
                  from your device.
                </p> <p><h4>Changes to This Terms and Conditions</h4></p> <p>
